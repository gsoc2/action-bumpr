...
post_pre_status() {
  ...
  post_txt="🏷️ [[bumpr]](https://github.com/gsoc2/action-bumpr)
...
post_post_status() {
  ...
  post_txt="🚀 [[bumpr]](https://github.com/gsoc2/action-bumpr) [Bumped!](${GITHUB_SERVER_URL}/${GITHUB_REPOSITORY}/actions/runs/${GITHUB_RUN_ID})
